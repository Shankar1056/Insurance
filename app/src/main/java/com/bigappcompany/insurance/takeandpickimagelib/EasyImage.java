package com.bigappcompany.insurance.takeandpickimagelib;
...
import static com.bigappcompany.insurance.takeandpickimagelib.EasyImageFiles.singleFileList;
...
public class EasyImage implements Constants {
    ...
    private static Intent createGalleryIntent(@NonNull Context context, int type) {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            intent.putExtra(Intent.EXTRA_ALLOW_REPLACE, configuration(context).allowsMultiplePickingInGallery());
        }
        return intent;
    }
